...
export default function ControlPanel({
  ...
  }, [isDragging, audioState.duration, onSeek]);
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            {!hasAudio ? (
              <Button
                ...
                className="text-teal-300 hover:text-teal-200 hover:bg-teal-500/10 gap-2"
              >
                <Upload className="w-4 h-4" />
                <span className="text-sm">上传音乐</span>
              </Button>
            ) : (
              <>
                <Button
                  ...
                  className="text-teal-300 hover:text-teal-200 hover:bg-teal-500/10 w-10 h-10"
                >
                ...
                {/* Time display */}
                <div className="text-xs text-slate-400 font-mono min-w-[80px]">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={`gap-2 ${hasLyrics ? 'text-teal-300 hover:text-teal-200' : 'text-slate-400 hover:text-slate-300'}`}
            >
              <FileText className="w-4 h-4" />
              <span className="text-sm">{hasLyrics ? '已导入歌词' : '导入歌词'}</span>
            </Button>
            <input
              ref={lyricsInputRef}
              type="file"
          ...
          {hasAudio && (
            <div className="flex items-center gap-2 w-32">
              <Button
                ...
                className="text-slate-400 hover:text-slate-300 w-8 h-8"
              >
                {audioState.volume === 0 ? (
          ...
          {hasAudio && (
            <div className="flex items-center gap-2 w-36">
              <Button
                ...
                className={`w-8 h-8 ${rainEnabled ? 'text-teal-400 hover:text-teal-300' : 'text-slate-400 hover:text-slate-300'}`}
              >
